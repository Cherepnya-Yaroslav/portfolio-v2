  ...
  return <>
    ...
    <main id="main">
      <section className="hero page-padding" id="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-portrait"><div className="portrait-parallax"><LoadingImage src={profile.portrait} statusVariant="hero" loadingLabel={locale === "ru" ? "Загружаем портрет" : "Loading portrait"} errorLabel={locale === "ru" ? "Портрет недоступен" : "Portrait unavailable"} alt={text.hero.alt} width={941} height={1672} preload sizes="(max-width: 700px) 95vw, (max-width: 1023px) 65vw, (min-width: 1840px) 920px, 50vw" className="portrait-image" /></div></div>
